...
def _preprocess_data(data, cfg):
    vocab = load_pkl('C:/Users/刘珂/PycharmProjects/HelloWorld/Hello/toolkit/deepke/data/out/vocab.pkl', verbose=False)
    relation_data = load_csv('C:/Users/刘珂/PycharmProjects/HelloWorld/hello/toolkit/deepke/data/origin/relation.csv', verbose=False)
...
# 自定义模型存储的路径
fp = 'C:/Users/刘珂/PycharmProjects/HelloWorld/hello/toolkit/deepke/checkpoints/2020-07-09_20-39-47/cnn_epoch50.pth'
