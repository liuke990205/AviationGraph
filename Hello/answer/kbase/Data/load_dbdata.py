...
def create_db():
    ...
    sql = """create table nlpccQA(entity VARCHAR(255) character set utf8 collate utf8_unicode_ci,
    attribute VARCHAR(255) character set utf8 collate utf8_unicode_ci, answer VARCHAR(255) character set utf8 
