...
from app.kbase.bert import optimization
from app.kbase.bert import tokenization
from app.kbase import lstm_crf_layer

import app.kbase.tf_metrics
import pickle
...
def create_model(bert_config, is_training, input_ids, input_mask,
    ...
    blstm_crf = lstm_crf_layer.BLSTM_CRF(embedded_chars=embedding, hidden_unit=FLAGS.lstm_size, cell_type=FLAGS.cell, num_layers=FLAGS.num_layers,
