...
from app.kbase.run_ner import create_model, InputFeatures, InputExample
from app.kbase.bert import tokenization
from app.kbase.bert import modeling
...
# 调参用的参数
task_name="ner"
data_dir="app/kbase/Data/NER_Data"
vocab_file="app/kbase/ModelParams/chinese_L-12_H-768_A-12/vocab.txt"
bert_config_file="app/kbase/ModelParams/chinese_L-12_H-768_A-12/bert_config.json"
output_dir="app/kbase/Output/NER"
init_checkpoint="app/kbase/ModelParams/chinese_L-12_H-768_A-12/bert_model.ckpt"
data_config_path="app/kbase/Config/NER/ner_data.conf"
do_lower_case = True
do_train=True
do_eval=True
max_seq_length=128
...
with graph.as_default():
    ...
    label_ids_p = tf.placeholder(tf.int32, [batch_size, max_seq_length], name="label_ids")
...
def predict_outline():
    ...
    with graph.as_default():
        ...
        for row in nlpcc_test_data.index:
            ...
            # pdb.set_trace()
        with open("./Data/NER_Data/q_t_a_testing_predict.txt", "w",encoding="utf8") as f:
